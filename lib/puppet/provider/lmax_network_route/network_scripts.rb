Puppet::Type.type(:lmax_network_route).provide(:network_scripts) do
  ...
  def exists?
    ...
    @config_file = "#{@@config_dir_routes}route-#{@resource[:name]}"
